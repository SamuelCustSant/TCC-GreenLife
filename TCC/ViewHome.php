    ...
    <div class="container-fluid">
      ...
      <div class="collapse navbar-collapse" id="navbarCollapse">
        <ul class="navbar-nav me-auto mb-2 mb-md-0">
          <li class="nav-item">
            <a class="nav-link active" aria-current="page" href="ViewPromocoes.html">Promoções</a>
          </li>
          <li class="nav-item">
            <a class="nav-link active" href="ViewAlimentacao.html">Alimentação</a>
          </li>
          <li class="nav-item">
            <a class="nav-link active" href="ViewVestuario.html">Vestuário</a>
          </li>
          <li class="nav-item">
            <a class="nav-link active" href="ViewHigiene.html">Higiene</a>
          </li>
          <li class="nav-item">
            <a class="nav-link active" href="ViewCosmeticos.html">Cosméticos</a>
          </li>
        </ul>
...
<br><br><br>
    ...
    <?php
        while($user_data = mysqli_fetch_assoc($result)): ?>
          ...
          <img src="<?= $user_data['imgdes']?>" class='card-img-top' alt='...'>
          <div class='card-body'>
            <h5 class='card-title'><center> <?= $user_data['produtodes'] ?> </center></h5>
            <p class='card-text' font face='Arial Light' size='5'><center><?= $user_data['precodes'] ?></center></font></p>
...
<div class="container">
  <footer class="py-3 my-4">
    <ul class="nav justify-content-center border-bottom pb-3 mb-3">
      <li class="nav-item"><a href="ViewPromocoes.html" class="nav-link px-2 text-muted">Promoções</a></li>
      <li class="nav-item"><a href="ViewAlimentacao.html" class="nav-link px-2 text-muted">Alimentação</a></li>
      <li class="nav-item"><a href="ViewVestuario.html" class="nav-link px-2 text-muted">Vestuário</a></li>
      <li class="nav-item"><a href="ViewHigiene.html" class="nav-link px-2 text-muted">Higiene</a></li>
      <li class="nav-item"><a href="ViewCosmeticos.html" class="nav-link px-2 text-muted">Cosméticos</a></li>
      <li class="nav-item"><a href="ViewFaleConosco.html" class="nav-link px-2 text-muted">Fale Conosco</a></li>
