...
<br><br><br>
      ...
      <font size="10" style= "font-family: 'Corbel'"><center>── PROMOÇÕES ──</center></font>
...
<div class="card" style="width: 18rem;">
  <img src="Images/promocoes/atum.png" class="card-img-top" alt="...">
  <div class="card-body">
    <h5 class="card-title"><center>Atum Vegano</center></h5>
    <p class="card-text"> <font face="Arial Light" size="2"><s>R$ 17,50</s></font></p>
...
<center>     
<div class="card" style="width: 18rem;">
  <img src="Images/promocoes/mascara.png" class="card-img-top" alt="...">
  <div class="card-body">
    <h5 class="card-title"><center>Máscara Facial</center></h5>
    <p class="card-text"> <font face="Arial Light" size="2"><s>R$ 07,50</s></font></p>
...
<center>
<div class="card" style="width: 18rem;">
  <img src="Images/promocoes/batom.png" class="card-img-top" alt="...">
  <div class="card-body">
    <h5 class="card-title"><center>Batom Vermelho</center></h5>
    <p class="card-text"> <font face="Arial Light" size="2"><s>R$ 12,20</s></font></p>
    <p class="card-text"> <font face="Arial Light" size="5">  R$ 8,90</font></p>
    <center><a href="#" class="btn btn-success"><b>Comprar</b></center></a>
  </div>
</div>
</center>
