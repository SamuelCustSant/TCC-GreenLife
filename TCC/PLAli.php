        ...
        <?php
            while($user_data = mysqli_fetch_assoc($result)): ?>
              ...
              <div class='card m-3' style='width: 18rem;'>
                <img src="/Images/alimentacao/<?= $user_data['imgali']?>" class='card-img-top' alt='...'>
                <div class='card-body'>
                  <h5 class='card-title'><center> <?= $user_data['produtoali'] ?> </center></h5>
                  <p class='card-text'><font size="5" style="font-family: Arial Light;"><center><?= $user_data['precoali'] ?></center></font></p>
                  <p class='card-text'><font size="4" style="font-family: Arial Light; color:red"><center><?= $user_data['descricaoali'] ?></center></font></p>                  
                  <center><a href=" <?= $user_data['linkali'] ?>" class='btn btn-success'><b>Comprar</b></center></a>
                </div>
              </div>
              </div>
