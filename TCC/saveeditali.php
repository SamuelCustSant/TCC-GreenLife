<?php
    ...
    if(isset($_POST['update']))
    {
        ...
        $sqlUpdate = "UPDATE alimentacao SET produtoali= '$produtoali',precoali= '$precodes',descricaoali= '$descricaoali',imgali= '$imgali',linkali= '$linkali'
