...
<font size="10" style= "font-family: 'Corbel'"><center>─ HIGIENE ─</center></font>
        ...
        <?php
            while($user_data = mysqli_fetch_assoc($result)): ?>
              ...
              <div class='card m-3' style='width: 18rem;'>
                <img src="/Images/higiene/<?= $user_data['imghig']?>" class='card-img-top' alt='...'>
                <div class='card-body'>
                  <h5 class='card-title'><center> <?= $user_data['produtohig'] ?> </center></h5>
                  <p class='card-text'><font size="5" style="font-family: Arial Light;"><center><?= $user_data['precohig'] ?></center></font></p>
                  <p class='card-text'><font size="4" style="font-family: Arial Light; color:red"><center><?= $user_data['descricaohig'] ?></center></font></p>
                  <center><a href=" <?= $user_data['linkhig'] ?>" class='btn btn-success'><b>Comprar</b></center></a>
                </div>
              </div>
