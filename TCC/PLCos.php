        ...
        <?php
            while($user_data = mysqli_fetch_assoc($result)): ?>
              ...
              <div class='card m-3' style='width: 18rem;'>
                <img src="/Images/cosmeticos/<?= $user_data['imgcos']?>" class='card-img-top' alt='...'>
                <div class='card-body'>
                  <h5 class='card-title'><center> <?= $user_data['produtocos'] ?> </center></h5>
                  <p class='card-text'><font size="5" style="font-family: Arial Light;"><center><?= $user_data['precocos'] ?></center></font></p>
                  <p class='card-text'><font size="4" style="font-family: Arial Light; color:red"><center><?= $user_data['descricaocos'] ?></center></font></p>
                  <center><a href=" <?= $user_data['linkcos'] ?>" class='btn btn-success'><b>Comprar</b></center></a>
                </div>
              </div>
