...
<div class="form-group">
  ...
  <div class="col-md-4">
  <input id="produtohig" name="produtohig" type="text" placeholder="Nome do Produto" class="form-control input-md" value="<?php echo $produtohig ?>">
...
<div class="form-group">
  ...
  <div class="col-md-4">
  <input id="precohig" name="precohig" type="text" placeholder="Preço" class="form-control input-md" value="<?php echo $precohig ?>">
...
<div class="form-group">
  ...
  <div class="col-md-4">                     
    <textarea class="form-control" id="descricaohig" name="descricaohig" value="<?php echo $descricaohig ?>" placeholder="Descrição"></textarea>
  </div>
</div>
...
<div class="form-group">
  ...
  <div class="col-md-4">
    <input id="imghig" name="imghig" class="input-file" type="file" value="<?php echo $imghig ?>">
  </div>
</div>
...
<div class="form-group">
  ...
  <div class="col-md-4">
  <input id="linkhig" name="linkhig" type="text" placeholder="Link Pag Seguro" class="form-control input-md" value="<?php echo $linkhig ?>">
    
  </div>
</div>

<input type="hidden" name="id" value="<?php echo $idhigiene ?>">
