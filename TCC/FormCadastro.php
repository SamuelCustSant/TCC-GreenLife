...
<header>
  <nav class="navbar navbar-expand-md navbar-dark fixed-top bg-success">
    <div class="container-fluid">
      <a href="ViewHome.html"><img src="Images/logorodape.png" class="navbar-brand" width="157" height="43"></a>
...
<center><h1><font style="font-family: Corbel">Fazer Cadastro</font></h1></center>


<center>
<div id="formlogin"> 

  <form action="FormCadastro.php" method="POST" class="form-horizontal">
<fieldset>
...
<center><a href="FormLogin.php"><font style="font-family: Corbel; font-size: small">Fazer Login</font></a></center>
